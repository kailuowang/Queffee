describe "Heap", ->
  ...
  describe "#extractTop", ->
    ...
    it "return top based on the comp function", ->
      heap = new Heap([6, 10, 7, 3, 9, 5], (a,b)-> a < b)
